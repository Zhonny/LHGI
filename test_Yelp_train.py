...
if __name__ == '__main__':
    ...
    metapaths = [[('business', 'reservation'), ('reservation', 'business')],
    ...
    weight_decay = 0
    model_saved_path = 'model_saved/LHGI-Yelp-business.pkl'
    embedding_save_path = 'embedding_saved/LHGI-Yelp-embedding-business'
    nodeType = 'business'
